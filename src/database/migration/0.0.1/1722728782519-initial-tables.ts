...
export class InitialTables1722728782519 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "app"."subject_tag" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "modified_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "created_by" integer NOT NULL, "modified_by" integer NOT NULL, CONSTRAINT "UQ_518505346360205ee36bc8eb90a" UNIQUE ("name"), CONSTRAINT "PK_d1b2388551fca7619b5699590dc" PRIMARY KEY ("id"))`);
