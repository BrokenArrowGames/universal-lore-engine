...
export class UserController {
  ...
  public createUser(
    ...
    ForbiddenError.from(req.user.ability).throwUnlessCan(AuthAction.CREATE, AuthSubject.USER);
  ...
  public readUser(
    ...
    ForbiddenError.from(req.user.ability).throwUnlessCan(AuthAction.READ, subject(AuthSubject.USER, { id }));
  ...
  public updateUser(
    ...
    ForbiddenError.from(req.user.ability).throwUnlessCan(AuthAction.UPDATE, subject(AuthSubject.USER, { id }));
  ...
  public deleteUser(
    ...
    ForbiddenError.from(req.user.ability).throwUnlessCan(AuthAction.DELETE, subject(AuthSubject.USER, { id }));
  ...
  public listUsers(
    ...
    ForbiddenError.from(req.user.ability).throwUnlessCan(AuthAction.LIST, AuthSubject.USER);
